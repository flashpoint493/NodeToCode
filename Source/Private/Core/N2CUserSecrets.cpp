...
void UN2CUserSecrets::LoadSecrets()
{
    ...
    // Extract Claude OAuth tokens (if present)
    ...
    // Extract Google OAuth tokens (if present)
    Google_OAuth_AccessToken = JsonObject->GetStringField(TEXT("Google_OAuth_AccessToken"));
    Google_OAuth_RefreshToken = JsonObject->GetStringField(TEXT("Google_OAuth_RefreshToken"));
    Google_OAuth_ExpiresAt = JsonObject->GetStringField(TEXT("Google_OAuth_ExpiresAt"));
    Google_OAuth_Scope = JsonObject->GetStringField(TEXT("Google_OAuth_Scope"));
...
void UN2CUserSecrets::SaveSecrets()
{
    ...
    JsonObject->SetStringField(TEXT("Google_OAuth_AccessToken"), Google_OAuth_AccessToken);
    JsonObject->SetStringField(TEXT("Google_OAuth_RefreshToken"), Google_OAuth_RefreshToken);
    JsonObject->SetStringField(TEXT("Google_OAuth_ExpiresAt"), Google_OAuth_ExpiresAt);
    JsonObject->SetStringField(TEXT("Google_OAuth_Scope"), Google_OAuth_Scope);
...
void UN2CUserSecrets::SetGoogleOAuthTokens(const FString& AccessToken, const FString& RefreshToken,
                                            const FString& ExpiresAt, const FString& Scope)
{
    Google_OAuth_AccessToken = AccessToken;
    Google_OAuth_RefreshToken = RefreshToken;
    Google_OAuth_ExpiresAt = ExpiresAt;
    Google_OAuth_Scope = Scope;

    SaveSecrets();

    FN2CLogger::Get().Log(TEXT("Google OAuth tokens saved successfully"), EN2CLogSeverity::Info);
}

bool UN2CUserSecrets::GetGoogleOAuthTokens(FN2COAuthTokens& OutTokens) const
{
    OutTokens.AccessToken = Google_OAuth_AccessToken;
    OutTokens.RefreshToken = Google_OAuth_RefreshToken;
    OutTokens.ExpiresAt = Google_OAuth_ExpiresAt;
    OutTokens.Scope = Google_OAuth_Scope;
...
{
    Google_OAuth_AccessToken.Empty();
    Google_OAuth_RefreshToken.Empty();
    Google_OAuth_ExpiresAt.Empty();
    Google_OAuth_Scope.Empty();

    SaveSecrets();

    FN2CLogger::Get().Log(TEXT("Google OAuth tokens cleared"), EN2CLogSeverity::Info);
}

bool UN2CUserSecrets::HasGoogleOAuthTokens() const
{
    return !Google_OAuth_AccessToken.IsEmpty() && !Google_OAuth_RefreshToken.IsEmpty();
}
